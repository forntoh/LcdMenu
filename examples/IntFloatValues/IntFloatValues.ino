...
MENU_SCREEN(mainScreen, mainItems,
    ITEM_BASIC("Con"),
    ITEM_RANGE<int>("Dist", 100, 1, 100, 200, [](const int value) { callbackInt(value); }, "%dm", 1, true),
    ITEM_RANGE<float>("Curr", -1.0f, 0.01f, -1.0f, 1.0f,[](const float value) { callbackFloat(value); }, "%.2fmA", 2),
